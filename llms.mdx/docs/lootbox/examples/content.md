# Examples (/docs/lootbox/examples)



Practical examples showing how to integrate sleepless\_lootbox with other resources and systems.

## Integration with ox\_target [#integration-with-ox_target]

Use ox\_target to let players open a lootbox by interacting with an object in the world.
...
## Dynamic Event Rewards [#dynamic-event-rewards]
...
## Preview Before Purchase [#preview-before-purchase]
...
## Register Lootboxes from Another Resource [#register-lootboxes-from-another-resource]
...
## Safe Open with Rolling Check [#safe-open-with-rolling-check]
...
## Bonus Items (Hidden Rewards) [#bonus-items-hidden-rewards]
...
## Custom Reward Types with Hooks [#custom-reward-types-with-hooks]
...
### Vehicle Reward Hook [#vehicle-reward-hook]
...
### Bank Money Reward Hook [#bank-money-reward-hook]
...
### Lootbox Config with Custom Rewards [#lootbox-config-with-custom-rewards]
