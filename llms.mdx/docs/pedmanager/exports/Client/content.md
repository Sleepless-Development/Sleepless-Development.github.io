# Client Exports (/docs/pedmanager/exports/Client)
...
### PedConfig Properties [#pedconfig-properties]
...
| `targetOptions`   | `table`                  | No       | An array of [ox\_target options](https://overextended.dev/ox_target)                |
| `interactOptions` | `table`                  | No       | A [sleepless\_interact Option or array of Options](/docs/interact/interact-options) |
...
### Example: Basic Ped with Target Options [#example-basic-ped-with-target-options]
...
### Example: Multiple Locations [#example-multiple-locations]
...
### Example: Animation with Prop and Interact Options [#example-animation-with-prop-and-interact-options]
