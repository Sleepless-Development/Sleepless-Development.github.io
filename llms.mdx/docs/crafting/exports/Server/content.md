# Server Exports (/docs/crafting/exports/Server)
...
### Example: VIP Tier Override [#example-vip-tier-override]
...
### Example: Job-Based Access Control [#example-job-based-access-control]
...
## loadStationsForProperty [#loadstationsforproperty]
...
### Custom Property Bridge [#custom-property-bridge]
