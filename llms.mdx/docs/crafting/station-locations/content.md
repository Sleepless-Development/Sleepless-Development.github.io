# Station Locations (/docs/crafting/station-locations)
...
#### Single Group (String) [#single-group-string]

```lua
groups = 'police'  -- Any police member can use
```

#### Multiple Groups (Array) [#multiple-groups-array]

```lua
groups = { 'police', 'ambulance' }  -- Police or ambulance can use
```

#### Groups with Grade Requirements (Table) [#groups-with-grade-requirements-table]
...
### Public Crafting Station [#public-crafting-station]
...
### Gang Hideout Station [#gang-hideout-station]
...
## Static vs Player-Placed Stations [#static-vs-player-placed-stations]
