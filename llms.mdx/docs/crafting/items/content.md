# Items Setup (/docs/crafting/items)
...
<Tabs items="['ox_inventory', 'qb-inventory']">
  <Tab>
    ## ox\_inventory Items [#ox_inventory-items]
  ...
  <Tab>
    ## qb-inventory Items [#qb-inventory-items]

    Add these items to your `qb-core/shared/items.lua` file:

    ### Crafting Bench [#crafting-bench-1]
...
## Custom Station Types [#custom-station-types]
