# Station Types (/docs/crafting/station-types)
...
## Station Type Properties [#station-type-properties]
...
#### Active Model Example [#active-model-example]
...
## Adding a New Station Type [#adding-a-new-station-type]
...
3. Create the corresponding inventory items (see [Items Setup](/docs/crafting/items))
