# Client Exports (/docs/waypoints/exports/Client)
...
### Example: Small Waypoint [#example-small-waypoint]
...
### Example: Checkpoint Waypoint [#example-checkpoint-waypoint]
...
### Example: Waypoint with Image [#example-waypoint-with-image]
...
### Updatable Properties [#updatable-properties]
...
### Example: Update Appearance [#example-update-appearance]
...
### Example: Dynamic Waypoint [#example-dynamic-waypoint]
...
### Example: Timed Removal [#example-timed-removal]
...
### Example: Conditional Removal [#example-conditional-removal]
...
### Example: Mission Cleanup [#example-mission-cleanup]
...
### Example: Resource Cleanup [#example-resource-cleanup]
...
### WaypointInstance Properties [#waypointinstance-properties]
...
### Example: Check Waypoint Exists [#example-check-waypoint-exists]
...
### Example: Calculate Distance to Waypoint [#example-calculate-distance-to-waypoint]
...
### Example: Get Waypoint Properties [#example-get-waypoint-properties]
