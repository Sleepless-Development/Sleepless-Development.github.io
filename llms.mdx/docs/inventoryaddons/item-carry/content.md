# Item Carry (/docs/inventoryaddons/item-carry)
...
### Box Carry (Walk Only, No Vehicles) [#box-carry-walk-only-no-vehicles]
...
### Briefcase Carry (Free Movement) [#briefcase-carry-free-movement]
