# Back Items (/docs/inventoryaddons/back-items)
...
### BackItem Properties [#backitem-properties]
...
### Custom Position Properties [#custom-position-properties]
...
### Normal Weapon Back Item [#normal-weapon-back-item]
...
### Non-Weapon Back Item [#non-weapon-back-item]
...
### Weapon with Alternative Model [#weapon-with-alternative-model]
...
### Weapon with Custom Position [#weapon-with-custom-position]
...
### Item with `ignoreLimits` [#item-with-ignorelimits]
