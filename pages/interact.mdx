...
Edit `client/modules/config.lua` to choose a theme, accent colors, compact prompt behavior, keybinds, and render distance. See the [Configuration](/interact/configuration) page for details, or [Custom Themes](/interact/custom-themes) to add your own look.
