    ...
    options = {
        {
            ...
            groups = {['police'] = 1},
            items = {['money'] = 100},
            onSelect =function(data) print("Global ped action triggered") end,
...
interact.removeGlobalPed(interactionId)
...
```lua
    exports.sleepless_interact:removeGlobalPed(interactionId)
```
